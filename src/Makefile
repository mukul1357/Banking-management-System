...
$(BIN_DIR)/$(SERVER_PROGRAM): $(BUILD_DIR)/server.o $(BUILD_DIR)/database.o
	$(LD) $(CFLAG) $(BUILD_DIR)/server.o $(BUILD_DIR)/database.o -o $(BIN_DIR)/$(SERVER_PROGRAM)


$(BUILD_DIR)/server.o: $(SRC_DIR)/server.c $(INCLUDE_DIR)/data_structures.h $(INCLUDE_DIR)/constants.h $(INCLUDE_DIR)/database.h $(INCLUDE_DIR)/server.h
	$(CC) -c $(SRC_DIR)/server.c -o $(BUILD_DIR)/server.o

$(BUILD_DIR)/client.o: $(SRC_DIR)/client.c $(INCLUDE_DIR)/data_structures.h $(INCLUDE_DIR)/constants.h  $(INCLUDE_DIR)/client.h
	$(CC) -c $(SRC_DIR)/client.c -o $(BUILD_DIR)/client.o

$(BUILD_DIR)/seed.o: $(SRC_DIR)/seed.c $(INCLUDE_DIR)/data_structures.h $(INCLUDE_DIR)/constants.h $(INCLUDE_DIR)/database.h
	$(CC) -c $(SRC_DIR)/seed.c -o $(BUILD_DIR)/seed.o

$(BUILD_DIR)/database.o: $(INCLUDE_DIR)/database.h $(INCLUDE_DIR)/data_structures.h $(INCLUDE_DIR)/constants.h
